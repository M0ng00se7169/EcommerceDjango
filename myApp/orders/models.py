...
class Order(models.Model):
    ...
    shipping_address = models.ForeignKey(Address, related_name="shipping_address", on_delete=False, null=True, blank=True)
    billing_address  = models.ForeignKey(Address, on_delete=False, related_name="billing_address", null=True, blank=True)
